...
assign o_rs1_rdata = (BYPASS_EN && i_rd_wen && (i_rs1_raddr == i_rd_waddr)

                    &&(i_rd_waddr != 5'd0)) ?

                    i_rd_wdata : mem[i_rs1_raddr];


assign o_rs2_rdata = (BYPASS_EN && i_rd_wen && (i_rs2_raddr == i_rd_waddr) 

                    &&(i_rd_waddr != 5'd0)) ?

                    i_rd_wdata : mem[i_rs2_raddr];
